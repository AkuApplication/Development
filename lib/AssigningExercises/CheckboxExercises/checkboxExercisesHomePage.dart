import 'package:chat_app/AssigningExercises/CheckboxExercises/checkboxExerciseCard.dart';
...
class _CheckboxExercisesHomePageState extends State<CheckboxExercisesHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Available Checkbox Exercises"),
      ),
        ...
        child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if(snapshot.hasData){
              ...
              List<CheckboxExerciseCard> recordCards = [];
              for(var record in records) {
                CheckboxExerciseRecord recordObject = CheckboxExerciseRecord(
                ...
                recordCards.add(CheckboxExerciseCard(
                  record: recordObject,
                ));
              }
